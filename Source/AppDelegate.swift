...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func generateImages() {
        let ids: [ImageIdentifier] = [
            ...
            .Cursor,
            .Drone(upgrade: FiveUpgrades(1), health: 100),
            .Drone(upgrade: FiveUpgrades(2), health: 100),
            .Drone(upgrade: FiveUpgrades(3), health: 100),
            .Drone(upgrade: FiveUpgrades(4), health: 100),
            .Drone(upgrade: FiveUpgrades(5), health: 100),
